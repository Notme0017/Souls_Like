...
namespace Invector.vCharacterController
{
    public class vThirdPersonMotor : MonoBehaviour
    {
        ...
        [Tooltip("Check This to use sprint on press button to your Character run until the stamina finish or moveAmount stops\nIf uncheck your Character will sprint as long as the SprintInput is pressed or the stamina finishes")]
        public bool useContinuousSprint = true;
        [Tooltip("Check this to sprint always in free moveAmount")]
        ...
        internal bool lockMovement = false;                 // lock the moveAmount of the controller (not the animation)
        internal bool lockRotation = false;                 // lock the rotation of the controller (not the animation)        
        internal bool _isStrafing;                          // internally used to set the strafe moveAmount                
        ...
        public class vMovementSpeed
        {
            ...
            [Tooltip("Character will limit the moveAmount to walk instead of running")]
